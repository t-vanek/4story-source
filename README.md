...
TWorldSvr         ██████░░░░░░░░░░░░░░   56%   (W3a-34 — tactics kickout + list, 69 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~19 100 | 69/287 + tactics kickout (forfeit/refund) + roster list | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE + TGUILDPVPRECORDTABLE) | 🟡 **W3a-34 — tactics kickout/list** |
