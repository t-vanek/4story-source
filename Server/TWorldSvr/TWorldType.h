...
typedef struct tagBOWTEMPPLAYERS            BOWTEMPPLAYER, *LPBOWTEMPPLAYER;
typedef struct tagBOWPLAYERS                BOWPLAYER, *LPBOWPLAYER;
typedef struct tagBRTEAMS                   TBRTEAMS, *LPTBRTEAMS;
typedef struct tagBRPLAYERS                 TBRPLAYERS, *LPTBRPLAYERS;
typedef struct tagBRTEMPPLAYER              BRTEMPPLAYER, *LPBRTEMPPLAYER;
///////////////////////////////////////////////////////////////////////////
...
typedef vector<BOWTEMPPLAYER>				VBOWPLAYER;
...
typedef map< DWORD, LPBOWTEMPPLAYER >       MAPBOWTEMPPLAYER, *LPMAPBOWTEMPPLAYER;
typedef map< DWORD, LPBOWPLAYER >           MAPBOWPLAYER, *LPMAPBOWPLAYER;

typedef map< DWORD, LPBRTEMPPLAYER >        MAPBRTEMPPLAYER, *LPMAPBREMPPLAYER;
typedef map< DWORD, LPTBRTEAMS >            MAPBRTEAMS, *LPMAPBRTEAMS;
typedef map< DWORD, LPTBRPLAYERS >          MAPBRPLAYERS, *LPMAPBRPLAYERS;

typedef map< DWORD, VBOWPLAYER>              MAPBOWGUILDPLAYER;
...
#define HOURLYREWARD_TICK                   (1 * 60 * 1000)
#define HOURLYREWARD_CASH                   (1)
//#define __TW_APEX
