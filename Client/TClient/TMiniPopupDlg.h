...
public:
	...
	private:
		CTButtonMP(CTMiniPopupDlg* pHost, FRAMEDESC_SHAREDPTR pDesc);
		CTButtonMP(CTMiniPopupDlg* pHost, const TButton& rSrcButton);
	};
...
public:
	CTMiniPopupDlg(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc, BOOL bStateMode);
