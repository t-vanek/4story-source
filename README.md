...
TWorldSvr         ████░░░░░░░░░░░░░░░░   49%   (W3a-25 — alliance + enemy state modelling, 57 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~16 800 | 57/287 + alliance/enemy ID state model completes W3a-22 (drained-and-dropped lists become real TGuild fields) | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE + TGUILDPVPRECORDTABLE) | 🟡 **W3a-25 — alliance/enemy state** |
