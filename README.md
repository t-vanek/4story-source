...
TWorldSvr         ██████░░░░░░░░░░░░░░   52%   (W3a-29 — PvP-point gain/use fan-in, 60 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~17 500 | 60/287 + PvP-point gain/use fan-in (char relay + guild bank mutation) | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE + TGUILDPVPRECORDTABLE) | 🟡 **W3a-29 — PvP-point gain/use** |
