...
TMultiLineEdit::TMultiLineEdit(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc)
	: TEdit(pParent, pDesc)
{
	Init();
	...
	{
		m_bShowCaret = TRUE;
		m_nCaretPosX = m_pCaret->m_pDESC->m_vCOMP.m_nPosX;
		m_nCaretPosY = m_pCaret->m_pDESC->m_vCOMP.m_nPosY;
	}*/
}

TMultiLineEdit::TMultiLineEdit(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc)
	: TMultiLineEdit(pParent, pDesc.lock())
{

}

TMultiLineEdit::TMultiLineEdit(TComponent* pParent, const TMultiLineEdit& rSrcMultiLineEdit)
	: TEdit(pParent, rSrcMultiLineEdit)
{
	Init();

	m_nCaretPosX = rSrcMultiLineEdit.m_nCaretPosX;
	m_nCaretPosY = rSrcMultiLineEdit.m_nCaretPosY;
}
