...
public:
	...
	TComponent*			m_pEND;
	TComponent*			m_pCLOSE;
	TComponent*         m_pAttrLevel;

	TImageList*			m_arGem[eDetailInfoGem_count];
...
public:
	CTDetailInfoDlg( TComponent*pParent, FRAMEDESC_SHAREDPTR pDesc, WORD wFrameID);
