...
TWorldSvr         ██████░░░░░░░░░░░░░░   50%   (W3a-26 — cabinet LIST stub, 58 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~16 900 | 58/287 + cabinet LIST wire-compat stub (empty-list reply; PUTIN/TAKEOUT + item codec deferred) | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE + TGUILDPVPRECORDTABLE) | 🟡 **W3a-26 — cabinet LIST stub** |
