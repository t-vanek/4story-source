...
{
public:
	TCombo(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc);
	TCombo(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc);
	TCombo(TComponent* pParent, const TCombo& rSrcCombo);
	virtual ~TCombo();
...
protected:
	...
	{
		return new TCombo(m_pParent, *this);
	};
