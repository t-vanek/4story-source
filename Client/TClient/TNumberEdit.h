...
public:
	CTNumberEdit(TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc, INT nValidCnt);
	CTNumberEdit(TComponent *pParent, FRAMEDESC_WEAKPTR pDesc, INT nValidCnt)
		: CTNumberEdit(pParent, pDesc.lock(), nValidCnt)
	{
