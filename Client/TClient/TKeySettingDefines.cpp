...
TKeySetInfo CTKeySetting::m_vDefInfo[TKEY_COUNT] = 
{
	...
	{ TRUE,     MAKELONG( VK_TAB, TKEYMOD_SHIFT),       TSTR_PRICK_PLAYER,          CString("TKEY_PICK_PLAYER") },
...
#ifdef NEW_IF
	{ TRUE,		MAKELONG( 'U', TKEYMOD_NONE),			TSTR_TOPMENU_RANKING,		CString("TKEY_HUD") },	
#else
	...
	{ TRUE,		MAKELONG( VK_OEM_PERIOD, TKEYMOD_NONE),			TSTR_TOPMENU_CD,			CString("TKEY_CASH_CAB") },
	{ TRUE,		MAKELONG( 'L', TKEYMOD_NONE),					TSTR_TOPMENU_TITLE,			CString("TKEY_TITLE") },
	{ TRUE,		MAKELONG( VK_OEM_COMMA, TKEYMOD_NONE),					TSTR_COMPANION,			CString("TKEY_COMPANION") },
	{ TRUE,		MAKELONG( '1', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_1,			CString("TKEY_PSKILL1") },			
	{ TRUE,		MAKELONG( '2', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_2,			CString("TKEY_PSKILL2") },			
	{ TRUE,		MAKELONG( '3', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_3,			CString("TKEY_PSKILL3") },			
	{ TRUE,		MAKELONG( '4', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_4,			CString("TKEY_PSKILL4") },			
	{ TRUE,		MAKELONG( '5', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_5,			CString("TKEY_PSKILL5") },			
	{ TRUE,		MAKELONG( '6', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_6,			CString("TKEY_PSKILL6") },			
	{ TRUE,		MAKELONG( '7', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_7,			CString("TKEY_PSKILL7") },			
	{ TRUE,		MAKELONG( '8', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_8,			CString("TKEY_PSKILL8") },			
	{ TRUE,		MAKELONG( '9', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_9,			CString("TKEY_PSKILL9") },			
	{ TRUE,		MAKELONG( '0', TKEYMOD_SHIFT),			TSTR_TKEY_SKILL_10,			CString("TKEY_PSKILL10") },			
	{ TRUE,		MAKELONG( VK_OEM_MINUS, TKEYMOD_SHIFT),	TSTR_TKEY_SKILL_11,			CString("TKEY_PSKILL11") },			
	{ TRUE,		MAKELONG( VK_OEM_PLUS, TKEYMOD_SHIFT),	TSTR_TKEY_SKILL_12,			CString("TKEY_PSKILL12") },	
};
// ==================================================================================================
...
const CString& CTKeySetting::GetKeyDesc(TKEY_SET eKey) const
{
	...
	if(m_vDefInfo[eKey].m_dwDescStrID == TSTR_COMPANION)
		strRESULT = "Companion";
	if(m_vDefInfo[eKey].m_dwDescStrID == TSTR_PRICK_PLAYER)
		strRESULT = "Next Player";
