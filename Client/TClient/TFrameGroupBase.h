...
public:
	CTFrameGroupBase(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc, DWORD dwInnerPosID);
	CTFrameGroupBase(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc, const CPoint& ptInnerPos);
