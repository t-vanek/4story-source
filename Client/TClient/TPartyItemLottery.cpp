...
FRAMEDESC_SHAREDPTR							CTPartyItemLottery::ms_pFRAMEDESC;
...
// ===============================================================================
void CTPartyItemLottery::InitInstance(TComponent* pPARENT, FRAMEDESC_SHAREDPTR pDESC, CSize szSCREEN)
{
	ReleaseInstance();
...
// ===============================================================================
CTPartyItemLottery::CTPartyItemLottery( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
