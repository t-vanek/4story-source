...
CTAuctionMainFrame::CTAuctionMainFrame( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc )
:	CTFrameGroupBase( pParent, pDesc, ID_CTRLINST_INNERPOS )
{
	FRAMEDESC_SHAREDPTR pListDesc = CTClientGame::GetInstance()->m_pTParser->FindFrameTemplate( ID_FRAME_AUCTION_LIST );
