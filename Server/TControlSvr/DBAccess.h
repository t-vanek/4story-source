...
public:
	...
	DWORD m_dwDuration;
	TCHAR m_szReason[MAX_FILENAME+1];
	BYTE m_bPermanent;
	TCHAR m_szOperator[MAX_FILENAME+1];
...
BEGIN_PARAM(6)
	...
	PARAM_ENTRY_STR(SQL_PARAM_INPUT, m_szReason)
	PARAM_ENTRY(SQL_PARAM_INPUT, m_bPermanent)
	PARAM_ENTRY_STR(SQL_PARAM_INPUT, m_szOperator)
END_PARAM()
};
