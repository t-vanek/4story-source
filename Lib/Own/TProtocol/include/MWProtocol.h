...
#define MW_CREATESPOLECNIKMON_ACK			(MW_BASE + 0x0190)
#define MW_CREATESPOLECNIKMON_REQ			(MW_BASE + 0x0191)
#define MW_SPOLECNIKMONDEL_ACK				(MW_BASE + 0x0192)
#define MW_SPOLECNIKMONDEL_REQ				(MW_BASE + 0x0193)

#define MW_ADDTOBOWQUEUE_REQ                (MW_BASE + 0x0194)
#define MW_BOWTIMEUPDATE_ACK                (MW_BASE + 0x0195)
#define MW_PREPAREFORBOW_REQ                (MW_BASE + 0x0196)
#define MW_BOWCOMMANDEXEC_REQ               (MW_BASE + 0x0197)
#define MW_ENDBOWWAR_REQ                    (MW_BASE + 0x0198)
#define MW_BOWPOINTSUPDATE_REQ              (MW_BASE + 0x0199)
#define MW_ADDTOBOWQUEUE_ACK                (MW_BASE + 0x019A)
#define MW_CANCELBOWQUEUE_REQ               (MW_BASE + 0x019B)
#define MW_CANCELBOWQUEUE_ACK               (MW_BASE + 0x019C)
#define MW_NOTIFYNONQUEUEDPLAYER_ACK        (MW_BASE + 0x019D)
#define MW_ADDBOWPLAYERS_ACK                (MW_BASE + 0x019E)
#define MW_LEAVEBATTLEFIELD_REQ             (MW_BASE + 0x019F)
#define MW_RELEASESINGLEBOWPLAYER_REQ       (MW_BASE + 0x0200)

#define MW_ADDTOBRQUEUE_REQ                 (MW_BASE + 0x0201)
#define MW_BRTIMEUPDATE_ACK                 (MW_BASE + 0x0202)
#define MW_BRTEAMMATEADD_ACK                (MW_BASE + 0x0203)
#define MW_BRTEAMMATEADD_REQ                (MW_BASE + 0x0204)

#define MW_BRTEAMMATEDEL_REQ                (MW_BASE + 0x0207)

#define MW_BRTEAMMATEADDRESULT_ACK          (MW_BASE + 0x0205)
#define MW_UPDATEBRTEAM_ACK                 (MW_BASE + 0x0206)

#define MW_ADDBRTEAMS_ACK                   (MW_BASE + 0x0207)
#define MW_PREPAREFORBR_REQ                 (MW_BASE + 0x0208)
#define MW_ADDTOBRQUEUE_ACK                 (MW_BASE + 0x0209)
#define MW_VOTEFORBRMAP_REQ                 (MW_BASE + 0x020A)

#define MW_BRCOMMANDEXEC_REQ                (MW_BASE + 0x020B)
#define MW_RELEASESINGLEBRPLAYER_REQ        (MW_BASE + 0x020C)
#define MW_ENDBRWAR_REQ                     (MW_BASE + 0x020D)

#define MW_RECALCCOUNTRYBALANCE_ACK         (MW_BASE + 0x021E)
#define MW_GUILDLOCALLIST_REQ               (MW_BASE + 0x021F)

#define MW_BATTLEMODESTATUS_REQ             (MW_BASE + 0x0220)
#define MW_BATTLEMODESTATUS_ACK             (MW_BASE + 0x0221)

#define MW_CMTELEPORTBATTLEMODE_REQ         (MW_BASE + 0x0222)
...
#define MW_GUILDSKILLACTION_REQ				(MW_BASE + 0x022B)
#define MW_GUILDSKILLACTION_ACK				(MW_BASE + 0x022C)

#define MW_UPDATEGUILDCOOLDOWN_ACK			(MW_BASE + 0x022D)
#define MW_UPDATEGUILDCOOLDOWN_REQ			(MW_BASE + 0x022E)
#define MW_ADDCOOLDOWN_REQ					(MW_BASE + 0x022F)
