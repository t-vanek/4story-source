...
TWorldSvr         ████░░░░░░░░░░░░░░░░   45%   (W3a-21 — PvP record audit log, 54 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~16 100 | 54/287 + batched per-row PvP record audit-log persistence (kPvPEventCount=8 buckets) | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE + TGUILDPVPRECORDTABLE) | 🟡 **W3a-21 — PvP record log** |
