...
public:
	...
	TFrame(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc);
	TFrame(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc);
	TFrame(TComponent* pParent, const TFrame& rSrcFrame);
	virtual ~TFrame();
...
protected:
	...
	{
		return new TFrame(m_pParent, *this);
	};
