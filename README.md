...
TWorldSvr         ████░░░░░░░░░░░░░░░░   44%   (W3a-20 — vestigial DB-server ACK echoes, 53 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~15 900 | 53/287 + vestigial DB-server ACK echoes silence "unknown wID" warnings on hybrid legacy deployments | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE) | 🟡 **W3a-20 — vestigial DB ACKs** |
