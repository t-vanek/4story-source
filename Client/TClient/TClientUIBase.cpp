...
CTClientUIBase::CTClientUIBase( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
...
void CTClientUIBase::SmoothCallback(std::vector<SmoothData> vComponent, std::vector<SmoothData> vImage)
{
