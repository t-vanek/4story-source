...
TWorldSvr         ████░░░░░░░░░░░░░░░░   37%   (W3a-15 — fame + article DB fan-in, 43 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~15 100 | 43/287 + DB-side fan-in extending to fame + article board ops | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE) | 🟡 **W3a-15 — fame + article fan-in** |
