...
// ======================================================================================
CTMiniPopupDlg::CTMiniPopupDlg(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc, BOOL bStateMode)
	: CTClientUIBase(pParent, pDesc), m_bStateMode(bStateMode), m_nLastSelIndex(T_INVALID)
{
	...
	m_pBtnTemplate = dynamic_cast<TButton*>(FindKid( ID_CTRLINST_MIDDLE ));
...
void CTMiniPopupDlg::AddButton(const CString& strTitle, DWORD dwMenuID)
{
	...
	CTButtonMP* pBtn = new CTButtonMP(this, *m_pBtnTemplate);
...
// ======================================================================================
CTMiniPopupDlg::CTButtonMP::CTButtonMP(CTMiniPopupDlg* pHost, FRAMEDESC_SHAREDPTR pDesc)
	: TButton(pHost,pDesc), m_pHost(pHost), m_nIndex(T_INVALID), m_fpAct(NULL), 
	  m_bDown(FALSE), m_dwUser(0)
{
}
// ======================================================================================
CTMiniPopupDlg::CTButtonMP::CTButtonMP(CTMiniPopupDlg* pHost, const TButton& rSrcButton)
	: TButton(pHost, rSrcButton), m_pHost(pHost), m_nIndex(T_INVALID), m_fpAct(NULL),
	m_bDown(FALSE), m_dwUser(0)
{
}
// ======================================================================================
