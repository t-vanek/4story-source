...
public:
	virtual void SetDisplayPet(const CString& strName, WORD wPetID, const CTime& tEndTime, BYTE m_bEffect);
...
protected:
	...
	CTClientPet* NewDisplayPet(const CString& strName, WORD wPetID, const CTime& tEndTime, BYTE m_bEffect);

public:
	CTPetDlg(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc, CD3DDevice* pDevice);
	virtual ~CTPetDlg();
};