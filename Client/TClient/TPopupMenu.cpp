...
CTPopupMenu::CTPopupMenu( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
...
void CTPopupMenu::AddMENU( CString strTitle,
						   TCOMMAND dwMenuID)
{
	TComponent *pTPANNEL = new TComponent( this, *m_pTBACK);
	TButton *pTMENU = new TButton( this, *m_pTBUTTON);
