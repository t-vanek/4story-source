...
public:
	...
	void SendMW_CASTLEOCCUPY_REQ(
		...
		CString strGuildName);
#ifdef SKYGARDEN
	void SendMW_SKYGARDENOCCUPY_REQ(
		BYTE bType,
		WORD wID,
		BYTE bCountry);
#endif
	...
	void SendMW_CASTLEAPPLY_REQ(
		...
		BYTE bCamp);
#ifdef SKYGARDEN
	void SendMW_SKYGARDENENABLE_REQ(
		BYTE bStatus,
		DWORD dwSecond,
		BYTE bSkyGardenDay,
	...
	void SendMW_CREATESPOLECNIKMON_REQ(
		DWORD dwCharID,
		DWORD dwKEY,
		DWORD dwMonID,
		WORD wMon,
	...
	void SendMW_SPOLECNIKMONDEL_REQ(
		DWORD dwCharID,
		DWORD dwKey,
			DWORD dwMonID,
		BYTE bForever);
...
//	Relay Message Sender
	...
	void SendMW_BOWTIMEUPDATE_ACK(BYTE bStatus, DWORD dwSecond, BYTE bDefugelPoints, BYTE bCraxionPoints);
	void SendMW_ADDTOBOWQUEUE_ACK(BYTE bResult, DWORD dwCharID, DWORD dwKEY, DWORD dwTick);
	void SendMW_CANCELBOWQUEUE_ACK(BYTE bResult, DWORD dwCharID, DWORD dwKEY, DWORD dwTick);
	void SendMW_NOTIFYNONQUEUEDPLAYER_ACK(DWORD dwCharID, DWORD dwKEY);
	void SendMW_PREPAREFORBOW_REQ(DWORD dwCharID, DWORD dwKEY, BYTE bTeam);
	void SendMW_BOWCOMMANDEXEC_REQ(BYTE bCommand);
	void SendMW_ENDBOWWAR_REQ(const MAPBOWPLAYER& mapBOWPlayers, BYTE bWinner);
	void SendMW_ADDBOWPLAYERS_ACK(const MAPBOWPLAYER& mapBOWPlayers);
	void SendMW_RELEASESINGLEBOWPLAYER_REQ(DWORD dwCharID, DWORD dwKEY, BYTE bWinner);

	void SendMW_BRTIMEUPDATE_ACK(BYTE bStatus, DWORD dwSecond, BYTE bType);
	void SendMW_BRTEAMMATEADD_ACK(DWORD dwCharID, DWORD dwKEY, BYTE bResult, CString strRequester = NAME_NULL);
	void SendMW_UPDATEBRTEAM_ACK(DWORD dwCharID, DWORD dwKEY, CString strChiefName, const MAPBRPLAYERS& mapBRPlayers, BYTE bTeamReady);
	void SendMW_ADDBRTEAMS_ACK(WORD wMapID, const MAPBRTEAMS& mapTeam, BYTE Mode);
	void SendMW_PREPAREFORBR_REQ(DWORD dwCharID, DWORD dwKEY, WORD wMapID);
	void SendMW_ADDTOBRQUEUE_ACK(BYTE bResult, DWORD dwCharID, DWORD dwKEY, DWORD dwTick);
	void SendMW_BRCOMMANDEXEC_REQ(BYTE bCommand);
	void SendMW_RELEASESINGLEBRPLAYER_REQ(DWORD dwCharID, DWORD dwKEY);
	void SendMW_ENDBRWAR_REQ(const MAPBRTEAMS& mapTeams);
	void SendMW_RECALCCOUNTRYBALANCE_ACK(BYTE bCountryCount[TCONTRY_B]);
	void SendMW_BATTLEMODESTATUS_ACK(DWORD dwCharID, DWORD dwKEY, CTBowSystem * pBOW, CBRSystem * pBR);
	void SendMW_GUILDSKILLACTION_ACK(DWORD dwCharID, DWORD dwKEY, BYTE Action, WORD Param[]);

	void SendMW_UPDATEGUILDCOOLDOWN_REQ(DWORD dwCharID, DWORD dwKEY, WORD wSkillID, BYTE bLevel, BOOL DidRenew, BOOL DidUse);

	void SendMW_ADDCOOLDOWN_REQ(DWORD dwGuildID, WORD SkillID);
	//Apex
