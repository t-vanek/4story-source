...
TWorldSvr         ████░░░░░░░░░░░░░░░░   42%   (W3a-18 — guild establishment flow, 50 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~15 700 | 50/287 + guild establishment flow (4-hop legacy roundtrip collapsed into one coroutine + repo->CreateGuild) | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE) | 🟡 **W3a-18 — establish guild** |
