...
TWorldSvr         ████░░░░░░░░░░░░░░░░   42%   (W3a-19 — wanted-board expiry sweep, 50 handlers + scheduler hook)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~15 800 | 50/287 + wanted-board periodic expiry sweep closes the W3a-11 TODO via RegistryRefresher hook | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE) | 🟡 **W3a-19 — wanted sweep** |
