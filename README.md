...
TWorldSvr         ███████████████░░░░░   73%   (W6-46 — EVENTQUARTER tools; 211/290 handlers, 100 tests)
─────────────────────────────────────────
...
│   ├── TWorldSvrAsio/              # 🟡 cluster coordinator — W6-46 (cash-shop + CMGift + item/event tools + service plane + MonthRank + war family)
...
* [`Server/TWorldSvrAsio/README.md`](Server/TWorldSvrAsio/README.md) — 🟡 W6-46 (guild/party/corps/social/territory/combat + connection/teleport + event incl. EVENTQUARTER tools + cash-shop + full CMGift + ctrl-svr + item tools + service plane + APEX stubs + MonthRank + war/castle family; gaps audit inside)
...
* **TWorldSvrAsio** — cluster coordinator, **~73 % ported** (211/290
  handlers, 100 in-process tests). Functionally-complete verticals:
