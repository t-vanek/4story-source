...
TWorldSvr         ███████████████░░░░░   73%   (W6-47 — lottery/gift rewards; 211/290 handlers, 101 tests)
─────────────────────────────────────────
...
│   ├── TWorldSvrAsio/              # 🟡 cluster coordinator — W6-47 (cash-shop + CMGift + item/event tools incl. rewards + MonthRank + war family)
...
* [`Server/TWorldSvrAsio/README.md`](Server/TWorldSvrAsio/README.md) — 🟡 W6-47 (guild/party/corps/social/territory/combat + connection/teleport + event incl. EVENTQUARTER tools + lottery/gift rewards + cash-shop + full CMGift + ctrl-svr + item tools + service plane + APEX stubs + MonthRank + war/castle family; gaps audit inside)
...
* **TMapSvrAsio** — Layered scaffold (transport → dispatch → handlers
  ...
  **combat / loot / mob-AI grind loop** and a first **kill-count quest**
  ...
  `CONSOLIDATION.md`.
* **TWorldSvrAsio** — cluster coordinator, **~73 % ported** (211/290
  handlers, 101 in-process tests). Functionally-complete verticals:
