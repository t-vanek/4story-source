...
static TComponent* m_pPointPH = NULL;
// CTShopSlot
// ====================================================================================================
...
// ====================================================================================================
CTShopBaseDlg::CTShopBaseDlg( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
	: CTClientUIBase(pParent, pDesc)
{
	...
	m_pPurchase	= static_cast<TButton*>(FindKid(26570));
	m_pCancel	= static_cast<TButton*>(FindKid(ID_CTRLINST_CANCEL));
	m_pTab      = static_cast<TButton*>(FindKid(5210));
	...
	if( pSlot0->m_pPoint || (m_id == ID_FRAME_PRIVATE_SHOP_NEW && m_pPointPH))
	{
		if (m_pPointPH && m_id == ID_FRAME_PRIVATE_SHOP_NEW)
		{
			pSlot0->m_pPoint = new TComponent(this, m_pPointPH->m_pDESC);
			pSlot0->m_pPoint->m_id = GetUniqueID();
			AddKid(pSlot0->m_pPoint);
		}
