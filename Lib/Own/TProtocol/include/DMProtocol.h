...
#define DM_GAINUSEABLEPVP_REQ			(DM_BASE + 0x00D2)
#define DM_GAINUSEABLEPVP_ACK			(DM_BASE + 0x00D3)
...
#define DM_CLEARTITLE_REQ				(DM_BASE + 0x00D0)
#define DM_SAVETITLE_REQ				(DM_BASE + 0x00D1)


#define DM_SAVEQUESTGUILD_ACK			(DM_BASE + 0x00F0)
#define DM_SAVEQUESTGUILDTERM_ACK		(DM_BASE + 0x00F1)
