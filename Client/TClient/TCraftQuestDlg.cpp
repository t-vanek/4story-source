...
TButton* CTCraftCategory::m_pTempCategoryPlusBtn = NULL;
TButton* CTCraftCategory::m_pTempCategoryMinusBtn = NULL;
...
CTCraftQuestDlg::CTCraftQuestDlg( TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc )
: CTClientUIBase( pParent, pDesc )
{
	...
	TButton* pCategoryPlusBtn = dynamic_cast<TButton*>(FindKid( ID_CTRLINST_BTN_PLUS));
	TButton* pCategoryMinusBtn = dynamic_cast<TButton*>(FindKid( ID_CTRLINST_BTN_MINUS ));
...
void CTCraftQuestDlg::AddCategory( DWORD dwCategoryID, CString strName )
{
	...
	if( it ==  m_mapCategory.end() )
	{
		...
		pCategory->m_pCategoryBar = new TComponent( this, *CTCraftCategory::m_pTempCategoryBar );
		pCategory->m_pName = new TComponent( this, *CTCraftCategory::m_pTempCategoryName );
		pCategory->m_pPlusBtn = new TButton( this, *CTCraftCategory::m_pTempCategoryPlusBtn );
		pCategory->m_pMinusBtn = new TButton( this, *CTCraftCategory::m_pTempCategoryMinusBtn );
