...
CTTextPopup::CTTextPopup( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
...
void CTTextPopup::SetText( CString& strTEXT )
{
	...
	{
		TComponent* pNewTEXT = new TComponent(NULL, *m_pTEXT);
		pNewTEXT->m_strText = outResult[ i ];
		m_vTEXT.push_back( pNewTEXT );

		TComponent* pNewBLOCK = new TComponent(NULL, *m_pMIDDLE);
