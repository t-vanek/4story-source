...
THttpCtrl::THttpCtrl(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc)
	: TComponent( pParent, pDesc)
{
	Init();
}

THttpCtrl::THttpCtrl(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc)
	: THttpCtrl(pParent, pDesc.lock())
{

}

THttpCtrl::THttpCtrl(TComponent* pParent, const THttpCtrl& rSrcHttpCtrl)
	: TComponent(pParent, rSrcHttpCtrl)
{
	Init();
}
