...
CTTournamentGage::CTTournamentGage( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc, TCMLParser *pParser, CTClientGame *pMainGame)
...
m_bShowPlayerInfo(TRUE)
{
	...
	for( int i=0 ; i < 2 ; ++i )
	{
		...
		FRAMEDESC_SHAREDPTR pGAUGE = pParser->FindFrameTemplate( ID_FRAME_TOURNAMENT_PARTY );
