...
class CTCharNewDlg : public CTInvenDlg
{
public:
	void EnableTLIGHT(
		CD3DCamera *pCamera,
...
public :
	...
	CTCharNewDlg( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc, TCMLParser *pParser, CD3DDevice *pDevice, WORD wFrameID, CTClientChar* pHost);
	virtual ~CTCharNewDlg();
};