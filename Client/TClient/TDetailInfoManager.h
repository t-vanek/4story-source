...
public:
	...
	static ITDetailInfoPtr NewAfterMathToolTip( CString strTitle, CString strAfter, CString strAfter2, const CRect& rc );
	static ITDetailInfoPtr NewBRTeamsToolTip( const CString& strTitle, const CString* strPlayer, const CRect& rc );
