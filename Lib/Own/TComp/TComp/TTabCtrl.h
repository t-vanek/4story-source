...
{
public:
	TTabCtrl(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc);
	TTabCtrl(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc);
	TTabCtrl(TComponent* pParent, const TTabCtrl& rSrcTabCtrl);
	virtual ~TTabCtrl();
	...
	BOOL InsertItem( int nItem, LPCTSTR lpszItem, FRAMEDESC_SHAREDPTR pDescFrame );
...
protected:
	...
	{
		return new TTabCtrl(m_pParent, *this);
	};
};
