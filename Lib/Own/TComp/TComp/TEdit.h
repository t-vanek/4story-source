...
public:
	...
	TEdit(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc);
	TEdit(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc);
	TEdit(TComponent* pParent, const TEdit& rSrcEdit);
	virtual ~TEdit();
...
protected:
	...
	{
		return new TEdit(m_pParent, *this);
	};
