...
public:
	void Init(UINT iIndex, const CString& strTitle, DWORD dwFlag, const CRect& rc, FRAMEDESC_SHAREDPTR pDescFastDown);
...
public:
	CTChatList(CTChatFrame* pHost, FRAMEDESC_SHAREDPTR pDesc, TComponent* pOuterParent);
	virtual ~CTChatList();
};
