...
TWorldSvr         ██████░░░░░░░░░░░░░░   51%   (W3a-27 — PvP point reward log reader, 59 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~17 100 | 59/287 + PvP point reward log reader pairs with W3a-14 writer (TGuild.point_log in-memory mirror) | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE + TGUILDPVPRECORDTABLE) | 🟡 **W3a-27 — point reward log** |
