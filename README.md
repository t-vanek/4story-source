...
TWorldSvr         ██████░░░░░░░░░░░░░░   51%   (W3a-28 — per-day vRecord + CalcWeekRecord, 59 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~17 300 | 59/287 + per-day vRecord history with proper 7-day rolling weekrecord (CalcWeekRecord trims + sums in one pass) | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE + TGUILDPVPRECORDTABLE) | 🟡 **W3a-28 — per-day vRecord** |
