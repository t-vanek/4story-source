...
// CTNormalCabinetDlg
// ====================================================================================================
CTNormalCabinetDlg::CTNormalCabinetDlg( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
...
void CTNormalCabinetDlg::SetupComponent()
{
	...
	static const DWORD dwOPENBTN[] = 
	{
		...
		ID_CTRLINST_CAB2_NEW,
		ID_CTRLINST_CAB3_NEW
	};
	...
	TComponent *pGetBtn = FindKid(ID_CTRLINST_CAB_TAKE_NEW);
