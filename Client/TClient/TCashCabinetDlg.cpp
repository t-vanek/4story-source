...
// CTCashCabinetDlg
// ====================================================================================================
CTCashCabinetDlg::CTCashCabinetDlg( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
...
void CTCashCabinetDlg::SetupComponent()
{
	...
	TComponent *pExtensionPeriodBtn = FindKid(ID_CTRLINST_CAB1_NEW);
	...
	m_pExtensionPeriodBtn = FindKid(ID_CTRLINST_CAB_EXTEND_NEW);
	...
	RemoveKid(m_pCashText);

	m_pCashPoints = FindKid(ID_CTRLINST_CAB_CASHPOINTS_NEW);

	m_pBonusPoints = FindKid(ID_CTRLINST_CAB_BONUSPOINTS_NEW);
								...
								DWORD dwBonusCash )
{
	...
	m_pCashPoints->m_strText.Format("Moonstones: %d", dwCash);
	m_pBonusPoints->m_strText.Format("Bonus Points: %d", dwBonusCash);
}
