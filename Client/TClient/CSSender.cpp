...
/*void CTClientSession::SendCS_HACKINFO_REQ(BYTE Disguise)
{
	CPacket vMSG;

	vMSG.SetID(CS_HACKINFO_REQ)
		<< Disguise;
	Say(&vMSG);
}*/

void CTClientSession::SendCS_WINLDISC_REQ()
{
	CPacket vMSG;

	vMSG.SetID(CS_WINLDIC_REQ);
	Say(&vMSG);
}
...
#ifdef MAGICITEMSHOP
void CTClientSession::SendCS_MAGICITEMBUY_REQ(
							 WORD wNpcID,
							 DWORD dwMagicItemID,
							 BYTE bCount,
							 BYTE bNpcInvenID,
							 BYTE bNpcItemID )
{
	...
	vMSG.SetID(CS_MAGICITEMBUY_REQ)
		<< wNpcID
		<< dwMagicItemID
		<< bCount
		<< bNpcInvenID
...
void CTClientSession::SendCS_DELSPOLECNIKMON_REQ( DWORD dwMonID, BYTE bMonType)
{
	CPacket vMSG;

	vMSG.SetID(CS_DELSPOLECNIKMON_REQ)
		<< dwMonID
		<< bMonType;
...
void CTClientSession::SendCS_PETEFFECTCHANGE_REQ(WORD wPetID, BYTE bEffect, WORD wPrice)
{
	CPacket vMSG;

	vMSG.SetID(CS_PETEFFECTCHANGE_REQ)
		<< wPetID
		<< bEffect
		<< wPrice;
...
void CTClientSession::SendCS_REQUESTSADDLE_REQ()
{
	CPacket vMSG;

	vMSG.SetID(CS_REQUESTSADDLE_REQ);
...
void CTClientSession::SendCS_TITLELIST_REQ()
{
	CPacket vMSG;

	vMSG.SetID(CS_TITLELIST_REQ);
	Say(&vMSG);
}
...
void CTClientSession::SendCS_CHANGETITLE_REQ(WORD wTitleID)
{
	CPacket vMSG;
	vMSG.SetID(CS_CHANGETITLE_REQ);
...
void CTClientSession::SendCS_TOURNAMENTAPPLY_REQ( BYTE bEntryID, CString strMACAddr )
{
	CPacket vMSG;
...
void CTClientSession::SendCS_ACDCLOSE_REQ( BYTE bType )
{
	CPacket vMSG;
...
void CTClientSession::SendCS_CHANGECOUNTRY_REQ(
	BYTE bType,
	BYTE bCountry,
	BYTE bInvenID,
	BYTE bItemID )
{
	CPacket vMSG;
	vMSG.SetID( CS_CHANGECOUNTRY_REQ )
		<< bType
		<< bCountry
		<< bInvenID
		<< bItemID;
...
void CTClientSession::SendCS_CREATESADDLE_REQ(BYTE m_bInvenID, 
											  BYTE m_bItemID)
{
	CPacket vMSG;

	vMSG.SetID(CS_CREATESADDLE_REQ)
		<< m_bInvenID
		<< m_bItemID;

	Say(&vMSG);
}
void CTClientSession::SendCS_DELETESADDLE_REQ(BYTE m_bInvenID, 
											  BYTE m_bItemID,
											  WORD m_wSaddleID)
{
	CPacket vMSG;

	vMSG.SetID(CS_DELETESADDLE_REQ)
		<< m_bInvenID
		<< m_bItemID
		<< m_wSaddleID;
...
void CTClientSession::SendCS_WARCOUNTRYBALANCE_REQ()
{
	CPacket vMSG;
	vMSG.SetID( CS_WARCOUNTRYBALANCE_REQ );
	Say(&vMSG);
}

void CTClientSession::SendCS_MEETINGROOM_REQ(
	BYTE bType,
	BYTE bValue,
	CString strName )
{
	CPacket vMSG;
	vMSG.SetID( CS_MEETINGROOM_REQ )
		<< bType
		<< bValue
		<< strName;
	Say(&vMSG);
...
void CTClientSession::SendCS_CMMOVE_REQ( BYTE bChannel, WORD wMapID, float fPosX, float fPosY, float fPosZ )
{
	CPacket vMSG;
	vMSG.SetID( CS_CMMOVE_REQ )
		<< bChannel
		<< wMapID
		<< fPosX
		<< fPosY
...
void CTClientSession::SendCS_CMMOVETOUSER_REQ( CString strUser )
{
	CPacket vMSG;
	vMSG.SetID( CS_CMMOVETOUSER_REQ )
		<< strUser;

	Say(&vMSG);
}

void CTClientSession::SendCS_CMGIFT_REQ( CString strUser, WORD wGiftID )
{
#ifdef ADD_CMGIFT
	CPacket vMSG;
	vMSG.SetID( CS_CMGIFT_REQ )
		<< strUser
		<< wGiftID;
...
void CTClientSession::SendCS_CMTELEPORTBATTLEMODE_REQ(BYTE bType)
{
	CPacket vMSG;
	vMSG.SetID(CS_CMTELEPORTBATTLEMODE_REQ)
		<< bType;
...
#ifdef ADD_SKYGARDEN
void CTClientSession::SendCS_ASSISTANT_REQ(
	CString strTarget )
{
	CPacket vMSG;
	vMSG.SetID( CS_ASSISTANT_REQ )
		<< strTarget;

	Say(&vMSG);
}

void CTClientSession::SendCS_ASSISTANTANSWER_REQ(
	BYTE bAnswer,
	CString strInviter )
{
	CPacket vMSG;
	vMSG.SetID( CS_ASSISTANTANSWER_REQ )
		<< bAnswer
		<< strInviter;
...
void CTClientSession::SendCS_ASSISTANTDEL_REQ(
	DWORD dwCharID )
{
	CPacket vMSG;
	vMSG.SetID( CS_ASSISTANTDEL_REQ )
		<< dwCharID;
...
void CTClientSession::SendCS_SOULLOTTERY_REQ()
{
	CPacket vMSG;
	vMSG.SetID( CS_SOULLOTTERY_REQ );

	Say(&vMSG);
}

void CTClientSession::SendCS_SOULLOTTERY_TRIGGER_REQ()
{
	CPacket vMSG;
	vMSG.SetID( CS_SOULLOTTERY_TRIGGER_REQ );
...
void CTClientSession::SendCS_SC_CREATECODE_REQ(CString strCode)
{
	CPacket vMSG;
	vMSG.SetID( CS_SC_CREATECODE_REQ )
		<< strCode;

	Say(&vMSG);
}

void CTClientSession::SendCS_SC_CHANGECODE_REQ(CString strOldCode, CString strNewCode)
{
	CPacket vMSG;
	vMSG.SetID( CS_SC_CHANGECODE_REQ )
		<< strOldCode
		<< strNewCode;
...
void CTClientSession::SendCS_SC_DISABLECODE_REQ(CString strCode)
{
	CPacket vMSG;
	vMSG.SetID( CS_SC_DISABLECODE_REQ )
		<< strCode;

	Say(&vMSG);
}

void CTClientSession::SendCS_SC_ENABLECODE_REQ()
{
	CPacket vMSG;
	vMSG.SetID( CS_SC_ENABLECODE_REQ );

	Say(&vMSG);
}

void CTClientSession::SendCS_SC_UNLOCK_REQ(CString strCode)
{
	CPacket vMSG;
	vMSG.SetID( CS_SC_UNLOCK_REQ )
		<< strCode;

	Say(&vMSG);
}

void CTClientSession::SendCS_SC_CHECKCODE_REQ(CString strCode, BYTE bWrongAttempts)
{
	CPacket vMSG;
	vMSG.SetID( CS_SC_CHECKCODE_REQ )
		<< strCode
		<< bWrongAttempts;
...
void CTClientSession::SendCS_SC_GETLOCKTIME_REQ()
{
	CPacket vMSG;
	vMSG.SetID( CS_SC_GETLOCKTIME_REQ );

	Say(&vMSG);
}
void CTClientSession::SendCS_GETREWARDS_REQ(BYTE bKind, WORD m_wUseValue)
{
	CPacket MSG;
	MSG.SetID(CS_GETREWARDS_REQ)
		<< bKind
		<< m_wUseValue;
...
void CTClientSession::SendCS_COMPANIONUPGRADE_REQ( BYTE bIndex, BYTE bSlot )
{
	CPacket MSG;
	MSG.SetID(CS_COMPANIONUPGRADE_REQ)
...
void CTClientSession::SendCS_USEPETITEM_REQ( DWORD dwPARAM, BYTE bCompanionSlot )
{
	CPacket pMSG;
	pMSG.SetID( CS_USEPETITEM_REQ )
		<< dwPARAM
		<< bCompanionSlot;
...
void CTClientSession::SendCS_DELETECOMPANION_REQ( BYTE bSlot )
{
	CPacket pMSG;
	pMSG.SetID(CS_DELETECOMPANION_REQ)
		<< bSlot;
...
void CTClientSession::SendCS_COMPANIONRECALL_REQ( DWORD dwMonID, BYTE bCompanionSlot )
{
	...
	vMSG.SetID(CS_COMPANIONRECALL_REQ)
		<< dwMonID
		<< bCompanionSlot;
...
void CTClientSession::SendCS_CREATECOMPANION_REQ(BYTE bInvenID, BYTE bSlotID, CString strName)
{
	CPacket vMSG;

	vMSG.SetID(CS_CREATECOMPANION_REQ)
		<< bInvenID
		<< bSlotID
		<< strName;
...
void CTClientSession::SendCS_COMPANIONLUP_REQ( BYTE bSlot )
{
	CPacket vMSG;

	vMSG.SetID( CS_COMPANIONLUP_REQ )
		<< bSlot;
...
void CTClientSession::SendCS_COMPANIONCANCEL_REQ()
{
	CPacket vMSG;

	vMSG.SetID(CS_COMPANIONCANCEL_REQ);

	Say(&vMSG);
}

void CTClientSession::SendCS_HIDECOMPANION_REQ()
{
	CPacket vMSG;

	vMSG.SetID(CS_HIDECOMPANION_REQ);


	Say(&vMSG);
}

void CTClientSession::SendCS_USECOMPANIONITEM_REQ( BYTE bInvenID, BYTE bSlot, BYTE bCompanionSlot )
{
	CPacket vMSG;

	vMSG.SetID(CS_USECOMPANIONITEM_REQ)
		<< bInvenID
		<< bSlot
		<< bCompanionSlot;
...
void CTClientSession::SendCS_DELETECOMPITEMS_REQ(BYTE bInvenID, BYTE bSlot, BYTE bItemSlot, BYTE bCompanionSlot )
{
	CPacket vMSG;

	vMSG.SetID( CS_DELETECOMPITEMS_REQ )
		<< bInvenID
		<< bSlot
		<< bItemSlot
		<< bCompanionSlot;
...
void CTClientSession::SendCS_CHANGECOMPANIONEFFECT_REQ( BYTE bSlot )
{
	CPacket pMSG;
	pMSG.SetID(CS_CHANGECOMPANIONEFFECT_REQ)
		<< bSlot;
...
void CTClientSession::SendCS_USECOMPANIONPOWDER_REQ( BYTE bInvenID, BYTE bItemID, BYTE bCompanionSlot )
{
	CPacket pMSG;
	pMSG.SetID(CS_USECOMPANIONPOWDER_REQ)
		<< bInvenID
		<< bItemID
		<< bCompanionSlot;
...
void CTClientSession::SendCS_USECOMPRESET_REQ(BYTE bInvenID, BYTE bItemID, BYTE bCompanionSlot)
{
	CPacket pMSG;
	pMSG.SetID(CS_USECOMPRESET_REQ)
		<< bInvenID
		<< bItemID
		<< bCompanionSlot;
...
void CTClientSession::SendCS_USEMEDALITEM_REQ(BYTE bInvenID, BYTE bItemID, BYTE bCount)
{
	CPacket pMSG;
	pMSG.SetID(CS_USEMEDALITEM_REQ)
		<< bInvenID
		<< bItemID
		<< bCount;
...
void CTClientSession::SendCS_VERIFYSESSION_ACK(DWORD dwCharID)
{
	CPacket pMSG;
	pMSG.SetID(CS_VERIFYSESSION_ACK)
		<< dwCharID;

	Say(&pMSG);
}

void CTClientSession::SendCS_PINGMEASUREMENT_REQ()
{
	CPacket pMSG;
	pMSG.SetID(CS_PINGMEASUREMENT_REQ)
		<< GetTickCount();

	Say(&pMSG);
}

void CTClientSession::SendCS_REGISTERBOW_REQ()
{
	CPacket pMSG;
	pMSG.SetID(CS_REGISTERBOW_REQ);

	Say(&pMSG);
}

void CTClientSession::SendCS_CANCELBOWQUEUE_REQ()
{
	CPacket pMSG;
	pMSG.SetID(CS_CANCELBOWQUEUE_REQ);

	Say(&pMSG);
}

void CTClientSession::SendCS_CASHBOWRESPAWN_REQ()
{
	CPacket pMSG;
	pMSG.SetID(CS_CASHBOWRESPAWN_REQ);

	Say(&pMSG);
}

void CTClientSession::SendCS_EXCHANGEBOWBP_REQ(DWORD dwMedals)
{
	CPacket pMSG;
	pMSG.SetID(CS_EXCHANGEBOWBP_REQ)
		<< dwMedals;

	Say(&pMSG);
}

void CTClientSession::SendCS_BOWRANKING_REQ()
{
	CPacket pMSG;
	pMSG.SetID(CS_BOWRANKING_REQ);

	Say(&pMSG);
}

void CTClientSession::SendCS_FINISHSKILL_ACK(DWORD dwAttackID,
											 DWORD dwID,
											 BYTE bType,
											 FLOAT fPosX,
										     FLOAT fPosY,
											 FLOAT fPosZ, 
											 const VTSKILLTARGET& vTarget,
											 WORD wSkillID,
											 BOOL IsLinked,
											 BOOL IsFake)
{
	...
	pMSG.SetID(CS_FINISHSKILL_ACK)
		...
		<< IsLinked
		<< IsFake
		<< pTGAME->GetPartyID(pTGAME->GetMainChar())
		<< BYTE(vTarget.size());
...
void CTClientSession::SendCS_LEAVEBATTLEFIELD_REQ()
{
	CPacket pMSG;
	pMSG.SetID(CS_LEAVEBATTLEFIELD_REQ);

	Say(&pMSG);
}
void CTClientSession::SendCS_REGISTERBR_REQ(BYTE bOnlyReady)
{
	CPacket pMSG;
	pMSG.SetID(CS_REGISTERBR_REQ)
		<< bOnlyReady;

	Say(&pMSG);
}

void CTClientSession::SendCS_BRTEAMMATEADD_REQ(CString strName)
{
	CPacket pMSG;
	pMSG.SetID(CS_BRTEAMMATEADD_REQ)
		<< strName;

	Say(&pMSG);
}

void CTClientSession::SendCS_BRTEAMMATEDEL_REQ(CString strName)
{
	CPacket pMSG;
	pMSG.SetID(CS_BRTEAMMATEDEL_REQ)
		<< strName;

	Say(&pMSG);
}

void CTClientSession::SendCS_BRTEAMMATEADDRESULT_ACK(BYTE bResult, CString strName)
{
	CPacket pMSG;
	pMSG.SetID(CS_BRTEAMMATEADDRESULT_ACK)
		<< bResult
		<< strName;
...
void CTClientSession::SendCS_VOTEFORBRMAP_REQ(CString strMap, BYTE Mode)
{
	CPacket pMSG;
	pMSG.SetID(CS_VOTEFORBRMAP_REQ)
...
void CTClientSession::SendCS_DONATELIFE_REQ(INT nID)
{
	CPacket pMSG;
	pMSG.SetID(CS_DONATELIFE_REQ)
		<< nID;

	Say(&pMSG);
}

void CTClientSession::SendCS_FINISHCOMPANIONTRANSFER_ACK(BYTE bSlot, BYTE bInvenID, BYTE bItemID)
{
	CPacket pMSG;
	pMSG.SetID(CS_FINISHCOMPANIONTRANSFER_ACK)
		<< bSlot
		<< bInvenID
		<< bItemID;
...
void CTClientSession::SendCS_CUSTOMCLOAK_LIST_REQ()
{
	CPacket vMSG;

	vMSG.SetID(CS_CUSTOMCLOAK_LIST_REQ);

	Say(&vMSG);
}
void CTClientSession::SendCS_CUSTOMCLOAK_CHANGE_REQ(WORD wID, DWORD dwMedals)
{
	CPacket vMSG;

	vMSG.SetID(CS_CUSTOMCLOAK_CHANGE_REQ)
		<< wID
		<< dwMedals;

	Say(&vMSG);
}
void CTClientSession::SendCS_QUESTPOSEXEC_REQ(DWORD dwQuestID, DWORD dwTermID)
{
	CPacket pMSG;
	pMSG.SetID(CS_QUESTPOSEXEC_REQ)
		<< dwQuestID
		<< dwTermID;
...
void CTClientSession::SendCS_GUILDSKILLACTION_REQ(BYTE bAction, WORD wParam[])
{
	CPacket pMSG;
	pMSG.SetID(CS_GUILDSKILLACTION_REQ)
		<< bAction
		<< BYTE(ARRAY_LEN(wParam));
...
void CTClientSession::SendCS_ARENAINFO_REQ(BYTE Arena)
{
	CPacket pMSG;
	pMSG.SetID(CS_ARENAINFO_REQ)
...
void CTClientSession::SendCS_ARENARANKING_REQ(BYTE Arena)
{
	CPacket pMSG;



	pMSG.SetID(CS_ARENARANKING_REQ)
		<< Arena;
