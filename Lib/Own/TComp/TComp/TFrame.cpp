...
TFrame::TFrame(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc)
	: TComponent(pParent, pDesc)
{
	Init();
}

TFrame::TFrame(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc)
	: TFrame(pParent, pDesc.lock())
{

}

TFrame::TFrame(TComponent* pParent, const TFrame& rSrcFrame)
	: TComponent(pParent, rSrcFrame)
{
	Init();
}
