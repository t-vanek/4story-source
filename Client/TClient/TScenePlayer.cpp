...
BYTE CTSpCode::CalcTick( CTClientGame *pTGAME, DWORD dwTick)
{
	...
	case TSCENE_PLAYER_CODE_SHOW_UI				: 
		{
			pTGAME->DisableUI(TFRAME_CINEMATIC);
			static_cast<CTPotionPannel*>(pTGAME->GetFrame(TFRAME_POTIONS))->HideAll();
		}
		break;
