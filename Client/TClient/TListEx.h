...
public:
	...
	public:
		TPrivateList(TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc);
	};
...
public:
	...
	void SetPageButton(FRAMEDESC_SHAREDPTR pDesc);
	//void SetTitle(FRAMEDESC_SHAREDPTR pDesc);
...
public:
	CTListEx(TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc);
	virtual ~CTListEx();
};
