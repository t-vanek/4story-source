#pragma once
class CTGuildJoinNewDlg: public ITInnerFrame
{
public:
...
public:
	...
	void ShowPopup2(const CPoint& pt);
	void CancelPopup();
...
public:
	...
	int OnGM_GVFPM_MAIL2();	///< GVFPM_MAIL2
...
public :
	CTGuildJoinNewDlg( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc, FRAMEDESC_SHAREDPTR pPopupDesc);
	virtual ~CTGuildJoinNewDlg();
};