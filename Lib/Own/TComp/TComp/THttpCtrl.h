...
{
public:
	THttpCtrl(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc);
	THttpCtrl(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc);
	THttpCtrl(TComponent* pParent, const THttpCtrl& rSrcHttpCtrl);
	virtual ~THttpCtrl();
...
protected:
	...
	{
		return new THttpCtrl(m_pParent, *this);
	};
};
