...
TTabCtrl::TTabCtrl(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc)
	: TComponent(pParent, pDesc)
{
	Init();
}

TTabCtrl::TTabCtrl(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc)
	: TTabCtrl(pParent, pDesc.lock())
{

}

TTabCtrl::TTabCtrl(TComponent* pParent, const TTabCtrl& rSrcTabCtrl)
	: TComponent(pParent, rSrcTabCtrl)
{
	Init();
}
...
BOOL TTabCtrl::InsertItem( int nItem, LPCTSTR lpszItem, FRAMEDESC_SHAREDPTR pDescFrame )
{
