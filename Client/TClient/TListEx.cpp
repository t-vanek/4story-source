...
// ====================================================================
CTListEx::TPrivateList::TPrivateList(TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
	: TList(pParent, pDesc)
{
}
// ====================================================================
...
// CTListEx
// ====================================================================
CTListEx::CTListEx(TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc)
...
// ====================================================================
void CTListEx::SetCommonList(FRAMEDESC_SHAREDPTR pDesc)
{
	if( m_bReady )
		return;
...
// --------------------------------------------------------------------
void CTListEx::SetScroll(FRAMEDESC_SHAREDPTR pDesc)
{
	if( m_bReady )
		return;
...
// --------------------------------------------------------------------
void CTListEx::SetPageButton(FRAMEDESC_SHAREDPTR pDesc)
{
	if( m_bReady )
		return;
...
// --------------------------------------------------------------------
/*void CTListEx::SetTitle(FRAMEDESC_SHAREDPTR pDesc)
{
	if( m_bReady )
		return;
...
void CTListEx::AddPageTitle( INT nCount, TComponent** pTitles )
{
	...
	{
		TComponent* pTCOMP = new TComponent( this, *pTitles[ i ] );
...
// --------------------------------------------------------------------
int CTListEx::AddPageList(FRAMEDESC_SHAREDPTR pDesc)
{
	if( m_bReady )
		return 0;
