...
protected:
	...
	static FRAMEDESC_SHAREDPTR			ms_pFRAMEDESC;
...
public:
	static void InitInstance(TComponent* pPARENT, FRAMEDESC_SHAREDPTR pDESC, CSize szSCREEN);
...
protected:
	CTPartyItemLottery( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc);
