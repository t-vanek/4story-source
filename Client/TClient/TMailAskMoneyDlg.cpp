...
// =======================================================
CTMailAskMoneyDlg::CTMailAskMoneyDlg(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc)
...
void CTMailAskMoneyDlg::AnswerPay(BOOL bPay)
{
	...
	else
	{
		...
		CTMailListFrame *pList = static_cast<CTMailListFrame*>(pGame->m_vTFRAME[TFRAME_MAIL]);
