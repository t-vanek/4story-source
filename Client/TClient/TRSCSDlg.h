...
public:
	CTClientUIBase *m_pRaidNew;
	TComponent *m_vTCOMP[TRSCSCOMP_COUNT];
	TComponent *m_pTSQUADNAME[TRSCSHOTKEY_COUNT];
	TComponent *m_pTUNITLEVEL[TRSCSHOTKEY_COUNT];
	TComponent *m_pTUNITNAME[TRSCSHOTKEY_COUNT];
	TComponent *m_pTUNITCHEF[TRSCSHOTKEY_COUNT];
	TComponent *m_pTUNITSELECT[TRSCSHOTKEY_COUNT];
	TComponent *m_pTSQUADCHEF[TRSCSHOTKEY_COUNT];
	TGauge *m_pTUNITGAUGE[TRSCSHOTKEY_COUNT];
	TButton *m_pTSQUADSELECT[TRSCSHOTKEY_COUNT];
...
public:
	CTRSCSDlg( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc, CTClientUIBase *pRaidNew);
	virtual ~CTRSCSDlg();
};
...
public:
	CTRSCSDlg( TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc);
	virtual ~CTRSCSDlg();
};
#endif