...
// ====================================================================================================
CTItemGambleDlg::CTItemGambleDlg(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc)
...
BOOL CTItemGambleDlg::SetItem(BYTE bSlotID, LPTITEM pItem, BYTE bInven, BYTE bInvenSlot)
{
	return CTItemSlotBaseDlg::SetItem( bSlotID, pItem, bInven, bInvenSlot );
}
