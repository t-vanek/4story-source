...
// Legacy Win32 resource IDs (formerly in Resource.h, which has been removed).
// These are still consumed by the ATL service / registry macros below; they
// will go away entirely once the ATL inheritance is replaced with the modern
// Asio service scaffolding.
...
protected:
	...
	void OnInvalidSession( CTMapSession *pSession);			// ��� ����
	void OnCloseSession( CTMapSession *pSession);			// ��� ����
	void ClosingSession( CTMapSession *pSession);			// ��� ����
	void CloseSession( CTMapSession *pSession);				// ������ �����Ϸ��� �� �Լ��� ȣ��
...
protected:
	...
	DWORD OnCT_USERKICKOUT_ACK(LPPACKETBUF pBUF); // ���·� ���� ��������
	DWORD OnCT_USERMOVE_ACK(LPPACKETBUF pBUF); // ���·� ���� ��ġ�̵�
	DWORD OnCT_MONSPAWNFIND_ACK(LPPACKETBUF pBUF); // ���·� ���� ����
