...
#define INVEN_BATTLE            ((BYTE) 0xFA) //Fuerza Arma
...
#define DUEL_AREAOUT_TIME	10						// 8초
...
#define BOW_SERVER_ID                   30
#define BOW_MAP_ID                      3000

#define BR_SERVER_ID                    50

#define BR_TEAMMATE_MAX_COUNT(x)        BYTE(x == BR_3V3 ? 3 : 2)




#define SKILL_RENEW_PRICE				300
#define LOCALOCCUPY_STATEXP				1000
#define CASTLEOCCUPY_STATEXP			2000
...
#define	CALCULATE_NEXTGEXP(CombatLevel)	DWORD(CombatLevel * 2400))
#define	CALCULATE_HITCHANCE(CombatLevel) (BYTE) FLOAT(((CombatLevel - 1) * 1.5f))
#define	CALCULATE_EVADE(CombatLevel) (BYTE) FLOAT(((CombatLevel - 1) * 2.0f))

#define	CALCULATE_NEXTEXP(MyStatLevel)	DWORD(MyStatLevel * 1200))
#define	CALCULATE_DAMAGE(MyStatLevel) (BYTE) FLOAT(((MyStatLevel - 1) * 5.0f))
#define	CALCULATE_ARMOR(MyStatLevel) (BYTE) FLOAT(((MyStatLevel - 1) * 12.0f))

typedef enum GUILDSKILL_ACTION
{
	GS_BUY,
	GS_RENEW,
	GS_GAINEXP,
...
typedef enum BRTEAMMATEADD_RESULT
{
	TEAMADD_SUCCESS = 0,
	TEAMADD_NOTFOUND,
	TEAMADD_BUSY,
...
typedef enum ITEMUPGRADE_RESULT
{
	...
	ITEMUPGRADE_MOGG_SUCCESS,
	ITEMUPGREAD_MOGG_WRONGKIND,
	ITEMUPGREAD_MOGG_SAMEITEM,
	ITEMUPGRADE_CANNOT_COLOR,
...
typedef enum BOWMATCH_RESULT
{
	BOWMATCH_SUCCESS = 0,
	BOWMATCH_FAIL
};

typedef enum BOWREG_RESULT
{
	BOWREG_SUCCESS = 0,
	BOWREG_COUNTRY,
	BOWREG_ALREADYINQUEUE,
	BOWREG_FAIL
};
////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////  TYPE DEFINE	/////////////////////////////////////////////
...
typedef enum SDT_STATUS_TYPE
{
	...
	SDT_STATUS_GMHIDE,
	SDT_STATUS_NONE0,
	SDT_STATUS_HUNTING_FEVER_EXP,
	SDT_STATUS_NONE1,
	SDT_STATUS_CLASS_BONUS,
	SDT_STATUS_MEDIUM_ITEMGUARD,
	SDT_STATUS_GREATER_ITEMGUARD,
	SDT_STATUS_COMPANION_FORTUNE,
	SDT_STATUS_COMPANION_PROTECTION,
	SDT_STATUS_GUILDMEMBER_EXP,
	SDT_STATUS_GUILD_EXP,
	SDT_STATUS_COUNT,
	SDT_STATUS_MAXHP_PERCENT_DECREASE = 115
} *LPSDT_STATUS_TYPE;
...
typedef enum TSKILLTARGET_TYPE
{
	...
	TSKILLTARGET_ORB,
	TSKILLTARGET_GUILDEXCEPTME,
	TSKILLTARGET_ENEMIESINFRONT,
	TSKILLTARGET_COUNT
} *LPTSKILLTARGET_TYPE;
...
typedef enum TSYSMSG_TYPE
{
	...
	SM_SKYGARDEN_END,			//천공전에서 %d 국가가 승리하였습니다.
};
...
typedef enum TSESSION_SC_TYPE
{
	TSESSION_SC_NORMAL,
	TSESSION_SC_WRITE	
};

typedef enum TSC_ACK_TYPE
{
	TSC_ACK_NONE,
	TSC_ACK_CODEEXIST,
	TSC_ACK_CODECREATESUCCESS,
	TSC_ACK_CODECREATEFAIL,
	TSC_ACK_ENABLED,
	TSC_ACK_CODECHANGED,
	TSC_ACK_CODEDISABLED,
	TSC_ACK_WRONGCODE,
	TSC_ACK_CODEUNLOCKED,
	TSC_ACK_CORRECTCODE,
	TSC_ACK_TOOMANYWRONGATTEMPTS,
	TSC_ACK_COUNT
};
typedef enum TSECURITYSYS_RESULTS
{
	CODE_CORRECT = 0,
	CODE_INCORRECT
};

typedef enum TBOW_COMMANDS
{
	BOW_START = 0,
	BOW_END,
	BOW_CLOSEGATES,
...
typedef enum BOWLEAVE_RESULT
{
	BOWLEAVE_FAIL,
	BOWLEAVE_SUCCESS
};

typedef enum PVP_SYSTEM
{
	SYSTEM_BOW = 0,
	SYSTEM_BR
};

typedef enum BR_COMMANDS
{
	BR_START = 0,
	BR_END
};
