...
public:
	TMultiLineEdit(TComponent* pParent, FRAMEDESC_SHAREDPTR pDesc);
	TMultiLineEdit(TComponent* pParent, FRAMEDESC_WEAKPTR pDesc);
	TMultiLineEdit(TComponent* pParent, const TMultiLineEdit& rSrcMultiLineEdit);
...
protected:
	...
	{
		return new TMultiLineEdit(m_pParent, *this);
	};
