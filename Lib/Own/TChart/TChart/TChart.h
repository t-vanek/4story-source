...
public:
	...
	static void InitTQUESTPOS( CString strPath);
	...
	static void InitTDESTINATION( CString strPath);
	static void InitTUNITLINK( CString strPath);
	static void ReleaseTPORTALLINK();
	static LPTPORTALLINK FindTPORTALLINK( DWORD dwID);
	static LPTPORTALLINK FindTPORTALLINK(
		WORD wMapID,
		BYTE bUnitX,
		BYTE bUnitZ);
	...
	static void InitTTITLETEMP( CString strPath );
	static void ReleaseTTITLETEMP();
	static LPTTITLE FindTTITLETEMP( DWORD dwTitleID);

	static void InitTTITLEGROUPTEMP( CString strPath );
	static void ReleaseTTITLEGROUPTEMP();
	static LPTTITLEGROUP FindTTITLEGROUPTEMP( BYTE wGroupID);
	...
	static void InitBattleInsignia(CString strPATH);
	static void ReleaseBattleInsignia();
	static BYTE FindRank(DWORD dwPoint);

	static void InitTArena( CString strPath );
	static void ReleaseTArena();
	static LPTARENA FindTArena( WORD wArena );

public:
	static CString m_vTSTRING[TSTR_COUNT];
	...
	static MAPTTITLETEMP m_mapTTITLETEMP;
	static MAPTTITLEGROUPTEMP m_mapTTITLEGROUPTEMP;
	...
	static MAPTARENA m_mapTArena;
	static MAPTPORTALLINK m_mapTPORTALLINK;
	static VECTORDWORD m_vBATTLERANK;
	static CString CustomStrings[][2];
};
