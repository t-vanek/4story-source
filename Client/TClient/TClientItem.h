...
public:
	...
	void SetGem(BYTE p);
	void SetMoggItemID(WORD p);
	void SetCompanionID(WORD p);
	...
	void SetAttrID(WORD p);
	void SetItemAttr(LPTITEMATTR p);
	void SetCustomTex( WORD wCustomTex );
...
public:
	...
	WORD GetCustomTex()				{ return m_wCustomTex; }
	BYTE GetGrade() const
	{
	...
	BYTE GetGem() const { return m_bGem; }
	WORD GetMoggItemID() const	{ return m_wMoggItemID; }
	WORD GetCompanionID() const	{ return m_wCompanionID; }
	BYTE GetGradeEffect() const { return m_bGradeEffect; }
