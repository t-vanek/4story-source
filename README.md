...
TWorldSvr         ████░░░░░░░░░░░░░░░░   34%   (W3a-14 — DB-side fan-in cohort, 39 handlers)
─────────────────────────────────────────
...
| **TWorldSvrAsio** | 38 851 | ~14 900 | 39/287 + DB-side fan-in cohort closing the bidirectional loop for duty/peer/contribution/level/point-reward | 🟡 W3a-* (TGUILD* + TGUILDCHART + TGUILDARTICLETABLE + TGUILDWANTEDTABLE + TGUILDVOLUNTEERTABLE + TGUILDPVPOINTREWARDTABLE) | 🟡 **W3a-14 — DB fan-in** |
