...
// WORD wPetID
#define CS_PETEFFECTCHANGE_REQ				(CS_MAP + 0x03A1)
//WORD wPetID
//BYTE bEffect
//WORD wPrice
#define CS_PETEFFECTCHANGE_ACK				(CS_MAP + 0x03A2)
//BYTE bResult
...
#define CS_TITLELIST_REQ					(CS_MAP + 0x0274)

#define CS_TITLELIST_ACK					(CS_MAP + 0x0275)

#define CS_CHANGETITLE_REQ					(CS_MAP + 0x0276)

#define CS_TITLEGAIN_ACK					(CS_MAP + 0x0277)

#define CS_TITLERESET_ACK					(CS_MAP + 0x0278)

#define CS_SETTIME_ACK						(CS_MAP + 0x0279)

#define CS_SOULUP_ACK						(CS_MAP + 0x027A)

#define CS_SOULLOTTERY_REQ					(CS_MAP + 0x027B)

#define CS_SOULLOTTERY_ACK					(CS_MAP + 0x027C)

#define CS_SOULLOTTERY_TRIGGER_REQ			(CS_MAP + 0x027D)

#define CS_SOULLOTTERY_TRIGGER_ACK			(CS_MAP + 0x027E)

#define CS_HEROGAIN_REQ						(CS_MAP + 0x027F)

#define CS_EXITTOURNAMETMAINTAIN_ACK		(CS_MAP + 0x0280)

#define CS_EXITTOURNAMETHOTKEY_ACK			(CS_MAP + 0x0281)
//////////////////////////////////////////////////////////////////////////
//Apex
...
#define CS_SC_CREATECODE_REQ					(CS_MAP + 0x0300)
#define CS_SC_CREATECODE_ACK					(CS_MAP + 0x0301)

#define CS_SC_CHANGECODE_REQ					(CS_MAP + 0x0302)
#define CS_SC_CHANGECODE_ACK					(CS_MAP + 0x0303)

#define CS_SC_DISABLECODE_REQ					(CS_MAP + 0x0304)
#define CS_SC_DISABLECODE_ACK					(CS_MAP + 0x0305)

#define CS_SC_ENABLECODE_REQ					(CS_MAP + 0x0306)
#define CS_SC_ENABLECODE_ACK					(CS_MAP + 0x0307)

#define CS_SC_UNLOCK_REQ						(CS_MAP + 0x0308)
#define CS_SC_UNLOCK_ACK						(CS_MAP + 0x0309)

#define CS_SC_CHECKCODE_REQ						(CS_MAP + 0x0310)
#define CS_SC_CHECKCODE_ACK						(CS_MAP + 0x0311)

#define CS_SC_GETLOCKTIME_REQ					(CS_MAP + 0x0312)
#define CS_SC_GETLOCKTIME_ACK					(CS_MAP + 0x0313)
/////BFG
#define CS_BFGTIMESET_ACK                       (CS_MAP + 0x0314)
#define CS_REGISTERBFG_REQ                      (CS_MAP + 0x0315)
#define CS_REGISTERBFG_ACK                      (CS_MAP + 0x0316)

#define CS_BODRANKLIST_REQ                      (CS_MAP + 0x0317)
#define CS_BODRANKLIST_ACK                      (CS_MAP + 0x0318)

#define CS_REQUESTSADDLE_REQ                    (CS_MAP + 0x0319)
#define CS_SENDSADDLE_REQ                       (CS_MAP + 0x0320)

#define CS_CREATESADDLE_REQ                     (CS_MAP + 0x0321)
#define CS_CREATESADDLE_ACK                     (CS_MAP + 0x0322)

#define CS_DELETESADDLE_REQ                     (CS_MAP + 0x0323)
#define CS_DELETESADDLE_ACK                     (CS_MAP + 0x0324)

#define CS_GETREWARDS_REQ                       (CS_MAP + 0x0325)
#define CS_GETREWARDS_ACK                       (CS_MAP + 0x0326)

#define CS_ARENALIST_ACK                        (CS_MAP + 0x0327)
#define CS_ARENALIST_REQ                        (CS_MAP + 0x0328)
#define CS_COMPANIONLIST_ACK                    (CS_MAP + 0x0329)
#define CS_COMPANIONLIST_REQ                    (CS_MAP + 0x032A)
#define CS_COMPANIONRECALL_REQ                  (CS_MAP + 0x032E)
#define CS_COMPANIONRECALL_ACK                  (CS_MAP + 0x032F)
#define CS_COMPANIONCANCEL_REQ                  (CS_MAP + 0x0330)
#define CS_COMPANIONCANCEL_ACK                  (CS_MAP + 0x0331)
#define CS_COMPANIONUPGRADE_REQ                 (CS_MAP + 0x032B)
#define CS_COMPANIONUPDATE_REQ                  (CS_MAP + 0x032C)
#define CS_COMPANIONLUPDATE_REQ                 (CS_MAP + 0x032D)    
#define CS_COMPANIONLUP_REQ                     (CS_MAP + 0x033A)    
#define CS_USEPETITEM_REQ                       (CS_MAP + 0x033B)
#define CS_UPDATECOMPANIONBYITEM_REQ            (CS_MAP + 0x033C)
#define CS_UPDATECOMPANIONBYSYSTEM_REQ          (CS_MAP + 0x033D)
#define CS_CREATECOMPANION_REQ                  (CS_MAP + 0x033E)
#define CS_DELETECOMPANION_REQ                  (CS_MAP + 0x033F)
#define CS_UPDATESPAWNEDCOMPANION_REQ           (CS_MAP + 0x0340)
#define CS_CREATECOMPANION_ACK                  (CS_MAP + 0x0341)
#define CS_HIDECOMPANION_REQ                    (CS_MAP + 0x0342)
#define CS_UPDATECOMPANIONITEMS_REQ             (CS_MAP + 0x0343)
#define CS_USECOMPANIONITEM_REQ                 (CS_MAP + 0x0344)
#define CS_DELETECOMPITEMS_REQ                  (CS_MAP + 0x0345)
#define CS_CHANGECOMPANIONEFFECT_REQ            (CS_MAP + 0x0346)
#define CS_CHANGECOMPANIONEFFECT_ACK            (CS_MAP + 0x0347)
#define CS_USECOMPANIONPOWDER_REQ               (CS_MAP + 0x0348)
#define CS_UPDATECOMPANIONBONUS_REQ             (CS_MAP + 0x0349)
#define CS_UPDATEMEDALS_REQ                     (CS_MAP + 0x0350)
#define CS_USEMEDALITEM_REQ                     (CS_MAP + 0x0351)
#define CS_DODGE_REQ                            (CS_MAP + 0x0352)
#define CS_DODGE_ACK                            (CS_MAP + 0x0353)

#define CS_QUESTPOSEXEC_REQ                     (CS_MAP + 0x0354)

#define CS_SPOLECNIKRECALL_REQ					(CS_MAP + 0x0360)
#define CS_SPOLECNIKRECALL_ACK					(CS_MAP + 0x0361)
#define CS_ADDSPOLECNIKMON_ACK					(CS_MAP + 0x0362)
#define CS_CHGMODESPOLECNIKMON_REQ				(CS_MAP + 0x0363)
#define CS_DELSPOLECNIKMON_ACK					(CS_MAP + 0x0364)
#define CS_DELSPOLECNIKMON_REQ					(CS_MAP + 0x0365)

#define CS_BOWTIMEUPDATE_ACK                    (CS_MAP + 0x0366)
#define CS_FORWARDBOWCHAT_ACK                   (CS_MAP + 0x0367)
#define CS_BOWNOTIFY_ACK                        (CS_MAP + 0x0368)
#define CS_REGISTERBOW_REQ                      (CS_MAP + 0x0369)
#define CS_REGISTERBOW_ACK                      (CS_MAP + 0x036A)
#define CS_CANCELBOWQUEUE_REQ                   (CS_MAP + 0x036B)
#define CS_CANCELBOWQUEUE_ACK                   (CS_MAP + 0x036C)
#define CS_NOTIFYNONQUEUEDPLAYER_ACK            (CS_MAP + 0x036D)
#define CS_UPDATEBONUSPOINT_ACK                 (CS_MAP + 0x036E)
#define CS_BOWKILLNOTIFY_ACK                    (CS_MAP + 0x036F)
#define CS_RELEASEFORBOW_REQ                    (CS_MAP + 0x0370)
#define CS_CASHBOWRESPAWN_REQ                   (CS_MAP + 0x0371)
#define CS_EXCHANGEBOWBP_REQ                    (CS_MAP + 0x0372)
#define CS_BOWPLAYERNOTIFY_ACK                  (CS_MAP + 0x0373)

#define CS_BOWRANKING_REQ                       (CS_MAP + 0x0374)
#define CS_BOWRANKING_ACK                       (CS_MAP + 0x0375)

#define CS_PINGMEASUREMENT_REQ                  (CS_MAP + 0x0370)
#define CS_PINGMEASUREMENT_ACK                  (CS_MAP + 0x0371)

#define CS_ACTITEMSUSE_REQ                      (CS_MAP + 0x0376)
#define CS_FINISHSKILL_ACK                      (CS_MAP + 0x0377)

#define CS_LEAVEBATTLEFIELD_REQ                 (CS_MAP + 0x0378)
#define CS_LEAVEBATTLEFIELD_ACK                 (CS_MAP + 0x0378)

#define CS_REGISTERBR_REQ                       (CS_MAP + 0x0379)
#define CS_BRTIMEUPDATE_ACK                     (CS_MAP + 0x037A)

#define CS_BRTEAMMATEADD_REQ                    (CS_MAP + 0x037B)
#define CS_BRTEAMMATEADD_ACK                    (CS_MAP + 0x037C)

#define CS_BRTEAMMATEADDRESULT_ACK              (CS_MAP + 0x037D)
#define CS_UPDATEBRTEAM_ACK                     (CS_MAP + 0x037E)

#define CS_BRTEAMMATEDEL_REQ                    (CS_MAP + 0x037F)
#define CS_UPDATEBRMATE_ACK                     (CS_MAP + 0x0380)

#define CS_INITBRTRANKING_ACK                   (CS_MAP + 0x0381)
#define CS_UPDATEBRTPLAYER_ACK                  (CS_MAP + 0x0382)
#define CS_ADDTOBRQUEUE_ACK                     (CS_MAP + 0x0383)

#define CS_VOTEFORBRMAP_REQ                     (CS_MAP + 0x0384)
#define CS_UPDATEREMAININGPLAYER_ACK            (CS_MAP + 0x0385)

#define CS_USECOMPRESET_REQ					    (CS_MAP + 0x0387)

#define CS_CHECKSESSIONVALIDITY_REQ             (CS_CUSTOM + 0x1000)
#define CS_VERIFYSESSION_ACK                    (CS_CUSTOM + 0x1001)

#define CS_SECURITYCONFIRM_REQ                  (CS_LOGIN + 0x0018)
#define CS_SECURITYCONFIRM_ACK                  (CS_LOGIN + 0x0019)
#define CS_SECURITYRESULT_ACK                   (CS_LOGIN + 0x0020)

#define CS_DONATELIFE_REQ                       (CS_MAP + 0x0386)
#define CS_FINISHCOMPANIONTRANSFER_ACK          (CS_MAP + 0x0390)

#define CS_CUSTOMCLOAK_LIST_ACK				    (CS_MAP + 0x0395)
#define CS_CUSTOMCLOAK_CHANGE_ACK		        (CS_MAP + 0x0396)

#define CS_CUSTOMCLOAK_LIST_REQ				    (CS_MAP + 0x0397)
#define CS_CUSTOMCLOAK_CHANGE_REQ				(CS_MAP + 0x0398)


#define CS_CMTELEPORTBATTLEMODE_REQ             (CS_MAP + 0x0500)
...
#define CS_GUILDSKILLACTION_REQ					(CS_MAP + 0x039A)
#define CS_GUILDSKILLACTION_ACK					(CS_MAP + 0x039B)

#define CS_GUILDSKILLUPDATE_ACK					(CS_MAP + 0x039C)

#define CS_ARENAINFO_REQ						(CS_MAP + 0x039D)
#define CS_ARENAINFO_ACK						(CS_MAP + 0x039E)
#define CS_ARENARANKINFO_ACK					(CS_MAP + 0x039F)

#define CS_ARENARANKING_REQ						(CS_MAP + 0x0540)
#define CS_ARENARANKING_ACK						(CS_MAP + 0x0541)