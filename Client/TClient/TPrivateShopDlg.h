...
public:
	CTPrivateShopDlg(TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc);
...
public:
	CTPrivateShopDlgForSell(TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc);
...
//
//public:
//	CTPrivateShopDlg(TComponent *pParent, FRAMEDESC_SHAREDPTR pDesc, BOOL bSell);
//	virtual ~CTPrivateShopDlg();
//};
